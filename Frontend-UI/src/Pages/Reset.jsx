...
export default function ForgotPassword() {
    ...
    const handlePasswordSubmit = async (data) => {
        try {
            await axios.post(`${BURL}/api/auth/reset-password`, {
                email: email,
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md text-center">
                    ...
                    <button onClick={() => navigate('/singin')} className="w-full bg-indigo-600 text-white py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors">
                        Back to Login
                    </button>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md relative">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <button
                                ...
                                className="w-full bg-indigo-600 text-white py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2 disabled:bg-indigo-900 disabled:cursor-not-allowed"
                            >
                ...
                {step === 2 && (
                    <div>
                        ...
                        <p className="text-gray-600 text-center mb-6">We've sent a 4-digit code to {email}</p>
                        ...
                        <div>
                            ...
                            <div className="text-center mb-4">
                                <button  onClick={otpForm.handleSubmit(handleOtpSubmit)}  type="button" className="text-sm text-indigo-600 hover:text-indigo-700">
                                    Resend OTP
                                </button>
                            </div>
                            <div className="text-center mb-4">
